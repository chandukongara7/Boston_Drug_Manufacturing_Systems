...
public class DrugInventoryWorkAreaPanel extends javax.swing.JPanel {
     ...
     */
    public DrugInventoryWorkAreaPanel(JPanel upContainer, EcoSystem sys, UserAccount ua, Organization org, Network ntw) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                .addGap(45, 45, 45)
                .addComponent(headerLbl, javax.swing.GroupLayout.PREFERRED_SIZE, 553, javax.swing.GroupLayout.PREFERRED_SIZE)
       ...
       TransportationWorkRequest transportrequest=new TransportationWorkRequest();
        ...
        if(ntw.getName().equals(this.ntw.getName())){
         ...
         CardLayout layout = (CardLayout) upContainer.getLayout();
          upContainer.add("ProcessRequest", new TransportRequestViewPanel(upContainer,ua));
