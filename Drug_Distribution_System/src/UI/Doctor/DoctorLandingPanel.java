...
userprocessContainer.add("DoctorPrescPanel", new UI.Doctor.ClinicMedOrderPanel(userprocessContainer, ua, docOrg,ent,system,ntw));// TODO add your handling code here:
...
CardLayout crd = (CardLayout) userprocessContainer.getLayout();
userprocessContainer.add("DoctorPrescPanel", new UI.Doctor.DoctorPrescPanel(userprocessContainer,presList,ua,ent,docOrg));// TODO add your handling code here:
crd.next(userprocessContainer);
