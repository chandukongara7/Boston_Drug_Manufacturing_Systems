 ...
 */
package Schema.DB4OUtil;

import Schema.Schema.ConfigureASystem;
...
public class DB4OUtil {
    ...
    private static final String FILENAME = System.getProperty("user.dir") + "/DataBank.db4o"; // path to the data store
